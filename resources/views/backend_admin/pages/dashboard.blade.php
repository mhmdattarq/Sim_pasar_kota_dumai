                            ...
                            <div class="categories-list">
                                <div class="d-flex align-items-center justify-content-between gap-3">
                                    ...
                                    <div class="flex-grow-1">
                                        <p class="mb-2">
                                            Mobiles <span class="float-end">75%</span>
                                        </p>
                                ...
                                <div class="d-flex align-items-center justify-content-between gap-3">
                                    <div class="">
                                        <img src="assets/images/avatars/avatar-1.png" class="rounded-circle"
                                            width="45" height="45" alt="user img" />
                                    </div>
                                    <div class="flex-grow-1">
                                    ...
                                    <div class="">
                                        <button type="button" class="btn btn-gradient-primary btn-sm rounded-4 px-4">
                                            Add
                                        </button>
                                    </div>
                                </div>
                    ...
                    <div class="card rounded-4 w-100">
                        <div class="card-body">
                            <ul class="nav nav-pills nav-fill mb-3">
                                <li class="nav-item">
                                    <a class="nav-link rounded-5" data-bs-toggle="pill"
                                        href="#primary-pills-home">Monthly</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link active rounded-5" data-bs-toggle="pill"
                                        href="#primary-pills-profile">Weekly</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link rounded-5" data-bs-toggle="pill"
                                        href="#primary-pills-contact">Daily</a>
                                </li>
                            </ul>
                    ...
                    <div class="card rounded-4 w-100">
                        ...
                        <ul class="list-group list-group-flush">
                            <li
                                ...
                                Chrome <span class="badge bg-danger rounded-pill">10</span>
                            </li>
                            <li class="list-group-item d-flex bg-transparent justify-content-between align-items-center">
                                Opera <span class="badge bg-primary rounded-pill">65</span>
                            </li>
                            <li class="list-group-item d-flex bg-transparent justify-content-between align-items-center">
                                Firefox
                    ...
                    <div class="card rounded-4 w-100">
                        ...
                        <table class="table table-borderless align-items-center">
                            <tbody>
                                <tr>
                                    <td>
                                        <i class="bx bxs-circle me-2" style="color: #5a52db"></i>
                                        Russia
                                    </td>
                                    <td>18 %</td>
                                    <td>
                                        <i class="bx bxs-circle me-2" style="color: #f09c15"></i>
                                        Australia
                                    </td>
                                    <td>14.2 %</td>
                                </tr>
                                <tr>
                                    <td>
                                        <i class="bx bxs-circle me-2" style="color: #b659ff"></i>
                                        India
                                    </td>
                                    <td>15 %</td>
                                    <td>
                                        <i class="bx bxs-circle me-2" style="color: #2ccc72"></i>
                                        United States
                                    </td>
                                    <td>11.6 %</td>
                                </tr>
                        ...
                        <table class="table align-middle mb-0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>#9405822</td>
                                    <td>
                                        <span class="btn btn-outline-success btn-sm px-4 rounded-5 w-100">Completed</span>
                                    </td>
                                    <td>$1250.00</td>
                                    <td>03 Feb 2020</td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>#8304620</td>
                                    <td>
                                        <span class="btn btn-outline-warning btn-sm px-4 rounded-5 w-100">Pending</span>
                                    </td>
                                    <td>$1500.00</td>
                                    <td>05 Feb 2020</td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>#4736890</td>
                                    <td>
                                        <span class="btn btn-outline-danger btn-sm px-4 rounded-5 w-100">Failed</span>
                                    </td>
                                    <td>$1400.00</td>
                                    <td>06 Feb 2020</td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>#8543765</td>
                                    <td>
                                        <span class="btn btn-outline-success btn-sm px-4 rounded-5 w-100">Paid</span>
                                    </td>
                                    <td>$1200.00</td>
                                    <td>14 Feb 2020</td>
                                    <td>
