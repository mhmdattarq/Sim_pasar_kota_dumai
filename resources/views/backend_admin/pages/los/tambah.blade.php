                    ...
                    <div class="ps-3">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Penambahan Los</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="border p-4 rounded">
                                <div class="card-title d-flex align-items-center">
                                    ...
                                    <h5 class="mb-0 text-info">Tambah los</h5>
                                </div>
                                <hr />
                                <form action="{{ route('los.store') }}" method="POST" class="user">
                                    @csrf
                                    <div class="row mb-3">
                                        <label for="nomor_los" class="col-sm-3 col-form-label">Nomor Los</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="nomor_los" name="nomor_los"
                                                placeholder="Masukkan Nomor Los..">
                                            @error('nomor_los')
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="ukuran_los" name="ukuran_los"
                                                placeholder="Masukkan Ukuran Los..">
                                            @error('nomor_kios')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="lokasi_los" name="lokasi_los"
                                                placeholder="Masukkan Lokasi Los..">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label for="pasar" class="col-sm-3 col-form-label">Pasar</label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <button type="submit" class="btn btn-info px-5">Tambah Los</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
