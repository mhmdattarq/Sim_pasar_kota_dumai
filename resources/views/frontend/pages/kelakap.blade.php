...
@section('content')
    ...
    <div class="container-fluid d-flex align-items-center justify-content-center"
        style="background-image: url('{{ asset('frontend/assets/img/pasar.jpg') }}');
            background-size: cover;
            background-position: center;
            background-repeat: no-repeat;
            min-height: 300px;">
        <div class="container text-center">
            <h3 class="display-3 mb-4 text-white">PASAR KELAKAP TUJUH</h3>
        </div>
    </div>
        ...
        <div class="container py-5">
            <div class="row g-5 align-items-center">
                ...
                <div class="col-lg-7"
                    ...
                    <p class="mb-4">Pasar Kelakap Tujuh merupakan pasar tradisional yang cukup ramai dengan komoditas
                        harian, di antaranya:</p>
